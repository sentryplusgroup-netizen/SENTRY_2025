...
model = YOLO("yolov8n_ncnn_model")  # replace with your trained model path
...
while True:
    ...
    # --- Run YOLO11 tracking ---
    results = model.track(frame, persist=True, tracker='botsort.yaml', conf=0.75, imgsz=320)
    ...
    if results and len(results) > 0:
        ...
        for box in boxes:
            ...
            if cls == 0 and conf > 0.85 and area >= MIN_AREA:
